(function() {
    ...
    JhiTrackerService.$inject = ['$rootScope', '$window', '$cookies', '$http', '$q', 'ServerURL'];

    function JhiTrackerService ($rootScope, $window, $cookies, $http, $q, ServerURL) {
        ...
        function connect () {
           ...
           // var url = '//' + loc.host + loc.pathname + 'websocket/tracker';
            var socket = new SockJS(ServerURL + 'websocket/tracker');
