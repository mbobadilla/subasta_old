(function() {
    ...
    JhiHealthService.$inject = ['$rootScope', '$http', 'ServerURL'];

    function JhiHealthService ($rootScope, $http, ServerURL) {
        var separator = '.';
        var service = {
        ...
        function checkHealth () {
            return $http.get(ServerURL + 'management/health').then(function (response) {
